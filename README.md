...
- **Flexible data input**: Accepts multiple Python/JSON time-series formats (list of dicts, list of lists, dict with date keys, nested history objects, or simple value lists)
