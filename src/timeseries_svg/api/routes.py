  ...
  -d '{{"data": [100.0, 102.5, 101.2, 105.0]}}'</code></pre>
    ...
    async def test_page():
        ...
        chart_data_with_dates = [
            ...
            {"d": "2024-01-22", "v": 105.0},
            {"d": "2024-01-23", "v": 95.0},
            {"d": "2024-01-24", "v": 117.0},
            {"d": "2024-01-25", "v": 118.0},
            {"d": "2024-01-26", "v": 120.0},
            {"d": "2024-01-29", "v": 128.0},
            {"d": "2024-01-30", "v": 130.0},
            {"d": "2024-01-31", "v": 120.0},
            {"d": "2024-02-01", "v": 117.0},
            {"d": "2024-02-02", "v": 118.0},
            {"d": "2024-02-05", "v": 116.0},
            {"d": "2024-02-06", "v": 125.0},
            {"d": "2024-02-07", "v": 130.0},
            {"d": "2024-02-08", "v": 134.0},
        ]
        ...
        <body>
            ...
            <div class="card">
                ...
                <textarea id="dataInput" placeholder='Enter JSON data, e.g.: [100.0, 102.5, 101.2] or [{{"d": "2024-01-01", "v": 150.0}}, ...]'>{sparkline_json}</textarea>
                ...
                <div id="chartOptions" style="display: none;">
                    ...
                    <div style="display: flex; gap: 16px; margin-bottom: 8px;">
                        ...
                        <div style="flex: 1;">
                            <label for="yAxisOffset">Y-axis Offset (optional):</label>
                            <input type="number" id="yAxisOffset" placeholder="0.1 = 10%" step="0.05" min="0" max="1" style="width: 100%;">
                        </div>
                    </div>
            ...
            <script>
                ...
                async function renderChart() {{
                    ...
                    if (chartType === 'chart' || chartType === 'bar') {{
                        ...
                        const yAxisOffset = document.getElementById('yAxisOffset').value;
                        if (yAxisOffset) body.y_axis_offset = parseFloat(yAxisOffset);
                    }}
        ...
        try:
            ...
            if request.chart_type == "bar":
                renderer = BarChartRenderer(
                    ...
                    y_axis_offset=request.y_axis_offset or 0.1,
                )
